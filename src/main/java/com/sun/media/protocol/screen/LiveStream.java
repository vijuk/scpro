...
public class LiveStream implements PushBufferStream, Runnable {
    ...
    protected VideoFormat rgbFormat;
	...
	maxDataLength = size.width * size.height * 3;
        ...
        JPEGFormat def = new JPEGFormat();
        
        System.out.println("size = " + size + " max = " + maxDataLength + " , " + Format.intArray +", " + frameRate + ", " + def.getQFactor() + ", " + def.getDecimation());
    /*
     rgbFormat = new JPEGFormat(size, maxDataLength,
				  Format.byteArray,
				  frameRate,
				  def.getQFactor(), def.getDecimation());
     */
	...
	*/
        rgbFormat = new VideoFormat(VideoFormat.JPEG, new Dimension(width, height), Format.NOT_SPECIFIED, Format.byteArray, (float) frameRate);
	...
	synchronized (this) {
        ...
        com.sun.image.codec.jpeg.JPEGEncodeParam encodeParam = com.sun.image.codec.jpeg.JPEGCodec.getDefaultJPEGEncodeParam(bi);
        
        com.sun.image.codec.jpeg.JPEGImageEncoder encoder = com.sun.image.codec.jpeg.JPEGCodec.createJPEGEncoder(byteStream);
        encoder.encode(bi,encodeParam);
        maxDataLength = byteStream.size();
        	buffer.setData(byteStream.toByteArray());
	System.out.println("Read " + maxDataLength + " bytes ");
                //removed by viju
